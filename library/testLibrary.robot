...
Login_to_account
    ...
    IF    ${is_new_page}
        New_login_page    ${email}    ${password}
    ELSE
        Old_login_page    ${email}    ${password}
    END
...
Email_validation
    ...
    ...    xpath=//*[@id="main-content"]/div/div/div[2]/x-wrapper-main/div/div/div[4]/div[1]/div[2]/div/div[2]
    ...    ${email}
...
Incomplete_email
    ...
    sleep    2
    ${message}=    get text
    ...    locator=//*[@id="sso"]/div/div[2]/main/div/div[2]/div/div/div/form/div[1]/div/div[2]/span
...
Sort_from_lowest_price
    ...
    # od najniższej
    click element
    ...    //*[@id="collection_view_sort-dropdown"]/div[2]/div/form/div/div[3]/div/label/span
    sleep    3
...
Add_to_cart
    ...
    # torby i plecaki
    click element
    ...    //*[@id="main-content"]/div/div[6]/div/div[1]/aside/ul/li/ul/li[5]/ul/li[1]/a/span
    ...
    click element
    ...    //*[@id="main-content"]/div/div[6]/div/div[2]/div[2]/div[2]/div[2]/div/article/a/figure/div/div/img
    wait until page contains    Dodaj do koszyka
    ${product_text}=    Get WebElement    //*[@id="main-content"]/div[1]/div/div[2]/h1/span
    ${product_name}=    get element attribute    ${product_text}    innerText
    log    ${product_name}
    click element
    ...    xpath://button[contains(@class, 'vfoVrE') and contains(@class, 'heWLCX') and contains(span, 'Dodaj do koszyka')]
    # Zapisanie nazwy produktu w pliku tekstowym
    Create File    ${product_file}    ${product_name}

Verification_of_added_product
    [Documentation]    Sprawdzenie czy produkt dodany wcześniej znajduje się w koszyku
    Login_to_account
    ...    email=${email}
    ...    password=${password}
    wait until page does not contain    Witaj ponownie
    click element    css=[data-testid="cart"]
...
Remove_from_cart
    [Documentation]    Usunięcie produktu z koszyka
    Login_to_account
    ...    email=${email}
    ...    password=${password}
    click element    css=[data-testid="cart"]
    wait until page contains    Koszyk (1 art.)
    click button    css=[data-id="article-remove"]
    wait until page contains    Artykuł usunięto.
    sleep    1
